...
// Added LayoutGrid for the new button
import { Search, Hospital, MapPin, Phone, Mail, Loader2, ChevronDown, X, LayoutGrid } from "lucide-react"
    ...
    return (
      ...
      <div className="w-full px-6 py-8 bg-secondary/20">
        <div className="max-w-4xl mx-auto">
          ...
          {/* MODIFIED SECTION: Added Topic Cluster link */}
          <div className="flex justify-between items-center mt-2">
            ...
            <div>
              <a href="/topic-clusters">
                <Button variant="ghost" className="text-sm text-primary hover:text-primary/90 font-medium">
